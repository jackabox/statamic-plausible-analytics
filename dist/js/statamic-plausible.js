...
Statamic.booting(function () {
    Statamic.$components.register('plausible-dashboard', __WEBPACK_IMPORTED_MODULE_0__Components_Dashboard___default.a);
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TopBrowser__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TopReferrers__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TopReferrers___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__TopReferrers__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__TopPages__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__TopPages___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__TopPages__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__VisitorOverview__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__VisitorOverview___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__VisitorOverview__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        VisitorOverview: __WEBPACK_IMPORTED_MODULE_3__VisitorOverview___default.a,
        TopReferrers: __WEBPACK_IMPORTED_MODULE_1__TopReferrers___default.a,
        TopBrowser: __WEBPACK_IMPORTED_MODULE_0__TopBrowser___default.a,
        TopPages: __WEBPACK_IMPORTED_MODULE_2__TopPages___default.a
    },
            ...
            return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.next = 2;
                            return fetch("/cp/plausible/api/top-browsers?period=" + this.period).then(function (res) {
                                return res.json();
                            }).then(function (res) {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.next = 2;
                            return fetch("/cp/plausible/api/top-referrers?period=" + this.period).then(function (res) {
                                return res.json();
                            }).then(function (res) {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.next = 2;
                            return fetch("/cp/plausible/api/top-pages?period=" + this.period).then(function (res) {
                                return res.json();
                            }).then(function (res) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue2_frappe__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Aggregates__ = __webpack_require__(26);
            ...
            return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.next = 2;
                            return fetch('/cp/plausible/api/timeseries?period=' + this.period).then(function (res) {
                                return res.json();
                            }).then(function (_ref2) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Charts__ = __webpack_require__(21);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Chart__ = __webpack_require__(22);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_frappe_charts_dist_frappe_charts_min_esm__ = __webpack_require__(24);
//
//
//
//
            ...
            return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.next = 2;
                            return fetch('/cp/plausible/api/aggregates?period=' + this.period).then(function (res) {
                                return res.json();
                            }).then(function (res) {
  ...
  return _c(
    ...
    _vm._l(_vm.data, function(item, key, index) {
      return _c(
        ...
        {
          key: key,
          staticClass: "p-2 -r w-1/4 last:border-0",
